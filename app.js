...
async function(personId) {
  ...
  /*
    IMPORTANT:
    Only the owner of this wishlist gets
    the Add Gift button.
  */
  ...
  /*
    Change browser hash so Back works
    consistently.
  */
    ...
    <main class="shell">
      ...
      <header class="hero">
        ...
        <p>
          ...
          ${
            isOwner
              ? "Add gifts whenever you want. Claiming is available throughout the entire year."
              : "Browse this wishlist anytime. Claiming is available throughout the entire year."
          }
      ...
      container.innerHTML = `
        ...
        >
          ...
          <p>
            ${
              isOwner
                ? "Add the first thing you'd genuinely love to receive."
                : "This wishlist doesn't have any gifts yet."
            }
          </p>
...
function(personId) {
  ...
  /*
    SECOND SAFETY CHECK:
    Even if someone somehow calls showAdd()
    manually, only the wishlist owner
    is allowed to open the form.
  */
  ...
  getCurrentUser().then(user => {
    ...
    if (
      ...
      alert(
        "You can only add gifts to your own wishlist."
      );
...
async function(personId) {
  ...
  /*
    FINAL FRONTEND OWNERSHIP CHECK.
  */
